...
drag_test = importfile_cd('auto_drag_test.csv',[2 Inf]);
...
%% Plots drag
figure(1);
plot(original.t,original.R3,'LineWidth',2,'Color','k')
hold on
plot(matlab_test.t,matlab_test.R3,'LineWidth',2,'Color','r')
grid on
xlabel 'Tiempo (s)'
legend('Original','Matlab Test')

% Plots coeff
% figure(2);
% plot(coeff.t,coeff.z,'LineWidth',2,'Color','k')
% hold on
% plot(coeff_test.t,coeff_test.z,'LineWidth',2,'Color','b')
% grid on
% xlabel 'Tiempo (s)'
% legend('Coefficients','Coeff Test')